...
const Body = () => {
  return (
    <div className='space-y-4 lg:flex lg:mt-5'>
     ...
     <div className='lg:flex-1 lg:order-1'>
      ...
      <form action="" className='flex flex-col gap-4 placeholder:text-gray-600 my-2 md:flex-row '>
        <input className='rounded-2xl px-4 py-3' type="email" placeholder='enter email address'/>
     ...
     {/* <div className='flex gap-3 lg:flex justify-end items-end'>
     <img src="./assets/check.svg" className=' w-6 h-6' alt="" />
      <p className='font-lato text-gray-600'>No spam ever, Do Unsubscribe anytime.</p>
     </div> */}
