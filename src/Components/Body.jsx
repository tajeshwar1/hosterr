  ...
  return (
    ...
    <div className='space-y-4 lg:flex lg:mt-5 mb-0'>
     ...
     <div className=' lg:flex-1 lg:order-1'>
      ...
      <p className='font-lato text-gray-700'>With hosterr, get your website up and running in no less than 5 mins* with 100 GB of free cloud storage if you pre-register now !!</p>
